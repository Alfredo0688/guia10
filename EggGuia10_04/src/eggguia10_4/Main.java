...
public class Main {
    ...
    public static void main(String[] args) {
       Circulo c1 = new Circulo(15.8,25);
       System.out.println("Area del círculo: " + c1.calcularArea());
       System.out.println("Perimetro del círculo: " + c1.calcularPerimetro());
       
       Rectangulo r1 = new Rectangulo(22.8,35);
       System.out.println("Area del círculo: " + r1.calcularArea());
       System.out.println("Perimetro del círculo: " + r1.calcularPerimetro());
    }
